...
def sample(
    ...
    **model_kwargs,
    ...
    # Initialize cache_position if not present
    ...
    pad_token_id = model_kwargs.get("pad_token_id") if model_kwargs.get("pad_token_id") is not None else self.generation_config.pad_token_id
    eos_token_id = model_kwargs.get("eos_token_id") if model_kwargs.get("eos_token_id") is not None else self.generation_config.eos_token_id
