...
class GenerationMode(ExplicitEnum):
    ...
    VCD_GENERATION = "vcd_generation"
    OPERA_GENERATION = "opera_generation"
    # Beam methods
...
class GenerationConfig(PushToHubMixin):
    ...
    def __init__(self, **kwargs):
        ...
        self.vcd_sample = kwargs.pop("vcd_sample", False)
        self.opera_decoding = kwargs.pop("opera_decoding", False)
        self.model_type = kwargs.pop("model_type", None)
        self.use_sid = kwargs.pop("use_sid", False)
        # Parameters that control the cache
        ...
        # VCD parameters
        self.vcd_inputs = kwargs.pop("vcd_inputs", None)
        self.cd_alpha = kwargs.pop("cd_alpha", 0.1)
        self.cd_beta = kwargs.pop("cd_beta", 0.2)

        # OPERA 
        self.key_position = kwargs.pop("key_position", None)
        self.scale_factor = kwargs.pop("scale_factor", 50.0)
        self.threshold = kwargs.pop("threshold", 10)
        self.num_attn_candidates = kwargs.pop("num_attn_candidates", 5)
        self.penalty_weights = kwargs.pop("penalty_weights", 1)
    ...
    def get_generation_mode(self, assistant_model: Optional["PreTrainedModel"] = None) -> GenerationMode:
        ...
        if self.opera_decoding:
            generation_mode = GenerationMode.OPERA_GENERATION
        ...
        if self.vcd_sample:
            assert self.vcd_inputs is not None, "vcd_inputs must be provided when vcd_sample is True"
            generation_mode = GenerationMode.VCD_GENERATION
