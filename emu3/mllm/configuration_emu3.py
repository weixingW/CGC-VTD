...
class Emu3Config(PretrainedConfig):
    ...
    def __init__(
        ...
        use_fast_v: bool = False,
        fast_v_sys_length: Optional[int] = None,
        fast_v_image_token_length: Optional[int] = None,
        fast_v_attention_rank_add: int = 100,
        fast_v_attention_rank: int = 100,
        fast_v_agg_layer: int = 2,
        fast_v_inplace: bool = False,
        **kwargs,
    ):
